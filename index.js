...
import wasmInit, {
    ...
    count_user_msg
}  from "./rust_code/pkg/hello_world.js";

export const runWasm = async (x,y) => {
  // Instantiate our wasm module
    const helloWorld = await wasmInit("./rust_code/pkg/hello_world_bg.wasm");
...
export const messageCount = async(message) => {
    const initWasm = await wasmInit("./rust_code/pkg/hello_world_bg.wasm");
